	DROP DATABASE IF EXISTS `bpmspace_demo_order`;
	CREATE DATABASE `bpmspace_demo_order` /*!40100 DEFAULT CHARACTER SET UTF8 */;

	CREATE TABLE `bpmspace_demo_order`.`demo_order_person` (
	 ...
	 CREATE TABLE `bpmspace_demo_order`.`demo_order_order` (
	...
	CREATE TABLE `bpmspace_demo_order`.`demo_order_order_person` (
	  ...
	  CREATE TABLE `bpmspace_demo_order`.`demo_order_person_person` (
	  ...
	  ALTER TABLE `bpmspace_demo_order`.`demo_order_order_person` 
	...
	ADD CONSTRAINT `demo_order_order_id_fk_1856`
	  ...
	  REFERENCES `bpmspace_demo_order`.`demo_order_order` (`demo_order_order_ID`)
	  ON DELETE NO ACTION
	  ON UPDATE NO ACTION;
	...
	ADD CONSTRAINT `demo_order_person_id_fk_3645`
	  ...
	  REFERENCES `bpmspace_demo_order`.`demo_order_person` (`demo_order_person_ID`)
	  ON DELETE NO ACTION
	  ON UPDATE NO ACTION;

	  ALTER TABLE `bpmspace_demo_order`.`demo_order_person_person` 
